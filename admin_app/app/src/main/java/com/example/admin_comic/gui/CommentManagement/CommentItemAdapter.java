...
import static com.example.admin_comic.gui.CommentManagement.CommentManagement.GetComments;
...
public class CommentItemAdapter extends RecyclerView.Adapter<CommentItemAdapter.ViewHolder> {
    ...
    public CommentItemAdapter(List<Comment> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(comment.getUser().getPhotoURL()).into(holder.avatar);
        ...
        builder.setMessage("Bạn có muốn xóa bình luận này không!")
                .setPositiveButton("Xóa", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Call<ApiResponse> call = comicService.deleteComment(commentId);
